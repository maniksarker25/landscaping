...
const PROJECT_IMAGES: Omit<LightboxItem, "id">[] = [
  ...
  },
  {
    ...
    category: "landscaping",
    imageUrl:
      "https://images.unsplash.com/photo-1416331108676-a22ccb276e35?q=75&w=800&auto=format&fit=crop",
  },
  {
  ...
  },
  {
    ...
    category: "outdoor-living",
    imageUrl:
      "https://images.unsplash.com/photo-1711114378509-acc95d490b25?q=75&w=800&auto=format&fit=crop",
  },
  {
    title: "PALM JUMEIRAH VILLA POOL",
    category: "pools",
    imageUrl:
      "https://images.unsplash.com/photo-1774597998589-a47635d76ee5?q=75&w=800&auto=format&fit=crop",
  },
  {
    title: "PEARL JUMEIRAH LANDSCAPE",
    category: "landscaping",
    imageUrl:
      "https://images.unsplash.com/photo-1645447556616-e9d1c52e8037?q=75&w=800&auto=format&fit=crop",
  },
  {
    title: "JUMEIRAH ISLAND SKIMMER POOL",
    category: "pools",
    imageUrl:
      "https://images.unsplash.com/photo-1700957814555-0a05851e1d21?q=75&w=800&auto=format&fit=crop",
  },
];

const INITIAL_ITEMS: LightboxItem[] = PROJECT_IMAGES.map((item, i) => ({
  ...item,
  id: `project-${i}`,
}));
...
export default function Gallery() {
  ...
  const filteredItems = useMemo(() => {
    if (activeCategory === "all") return INITIAL_ITEMS;
    return INITIAL_ITEMS.filter((item) => item.category === activeCategory);
  }, [activeCategory]);
  ...
  const getItemCount = (categoryValue: string) => {
    if (categoryValue === "all") return INITIAL_ITEMS.length;
    return INITIAL_ITEMS.filter((i) => i.category === categoryValue).length;
  };
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 animate-fade-in">
        ...
        {/* {!isProjectsPage && (
          <div className="mt-8 sm:mt-10 flex justify-center">
            <Link
              href="/projects"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-primary px-7 py-3.5 text-xs sm:text-sm font-bold text-primary-foreground shadow-md hover:bg-primary/90 hover:shadow-lg transition-all duration-300 hover:scale-[1.02] transform-gpu"
            >
