    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger asChild>
        <button
          ...
          className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-primary text-white shadow-xs transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 lg:hidden"
        >
          <Menu className="h-6 w-6 stroke-[2.5]" strokeWidth={2.5} aria-hidden="true" />
        </button>
      </Dialog.Trigger>
