    ...
    >
      ...
      <div className="p-6">
        ...
        <h3 className="mt-2 flex items-center justify-between gap-2 font-display text-lg">
          {project.title}
          <ArrowUpRight className="h-4 w-4 shrink-0 text-muted-foreground transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-accent" aria-hidden="true" />
        </h3>
